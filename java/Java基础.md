- [Java基础](#java基础)
  ...
  - [八、异常](#八异常)
  - [九、泛型](#九泛型)
    - [**1.泛型方法与可变参数**](#1泛型方法与可变参数)
    - [**2.泛型与静态方法**](#2泛型与静态方法)
    - [**3.擦拭法**](#3擦拭法)
    - [**4.泛型的继承关系**](#4泛型的继承关系)
    - [5.extends通配符（上边界通配符）](#5extends通配符上边界通配符)
      - [**extends通配符的作用**](#extends通配符的作用)
      - [小结](#小结)
    - [6.super通配符](#6super通配符)
    - [7.对比extends和super通配符](#7对比extends和super通配符)
    - [8.PECS原则](#8pecs原则)
    - [9.谨慎使用泛型可变参数](#9谨慎使用泛型可变参数)
# Java基础
